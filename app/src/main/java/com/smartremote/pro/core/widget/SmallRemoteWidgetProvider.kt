...
class SmallRemoteWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_WIDGET_PREFIX = "com.smartremote.pro.WIDGET_SMALL_"
        ...
        fun updateAppWidget(
            ...
            views.setOnClickPendingIntent(R.id.widget_btn_power, getPendingIntent(context, "power", 101))
            views.setOnClickPendingIntent(R.id.widget_btn_vol_down, getPendingIntent(context, "volDown", 102))
            views.setOnClickPendingIntent(R.id.widget_btn_vol_up, getPendingIntent(context, "volUp", 103))

            appWidgetManager.updateAppWidget(appWidgetId, views)
        }

        private fun getPendingIntent(context: Context, command: String, requestCode: Int): PendingIntent {
            val intent = Intent(context, SmallRemoteWidgetProvider::class.java).apply {
